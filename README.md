...
I used to have trouble with work life balance. I still do, but I'm much better about it. Please respect my attempt at a work life balance - I need my time and physical breaks. 
...
**Context-awareness.** Nothing that we do happens in a vacuum. In fact, making the right decisions is foremost about understanding the context we’re operating in. This can be anything from interpersonal to organisation-wide, from understanding customer needs to market forces and policy constraints. Transparency helps me keep this in mind. 

**Self-reflection.** I expect great work from myself and the people around me. We can’t improve if we remain unaware of our weak spots. We should all regularly take time to reflect on why we made a certain decision, why we reacted in a certain way.
...
- Something I'm working on is, I can tend to focus on eliminating the negatives way more than I focus on accentuating the positives. I see problems pretty much everywhere I look and I enjoy solving them. This sometimes means I don’t pay attention to the good things that are happening. Check in with me if you think I'm doing this and encourage me to focus on positives without encroaching toxic positivity culture.
- Similarly, I spot dysfunction way sooner than most people, especially structural organisational problems. I have found myself the canary in a coal mine more than once. This has taken a personal toll more than once, and it’s something I’m very mindful of limiting the impact of in the future. 
...
**1. Please don’t hold back:** Challenge my ideas and opinions. If you notice that I‘m making a bad decision, let me know and explain what I should be doing differently. If you truly liked something I did — I like to hear that too. My love language isn't words of appreciation, but that doesn't mean I don't want any, please express appreciation and recognition for my work. My instinct is to treat you the same, so if you would prefer to be approached differently, please let me know. 

**2. Be collaborative:** I’m very collaborative which means I like to discuss decisions and options. I try not to get stuck in one position or opinion, I have a very open mind but the downside is you won’t always get a quick judgment out of me since I prefer to talk it through and see some ideas/data/options. If you need a decision quickly, make sure I know it. 
...
**4. Clarify:** Don’t give clues or expect me to read between the lines. Tell me what you need. I enjoy direct and clear communication. 
- That means clarifying the purpose of a meeting, a brainstorm, an initiative: "Is this a meeting for leadership to share updates? Is this a meeting for the team to brainstorm ideas? Is this a meeting for us to collect questions and answer? Or only collect questions? When we say we will follow up, what are the guidelines and how do we hold people accountable to them?"
- If my own communication was lost in translation, I'd love some initial empathy and active listening: "What did you actually mean when you said X? I interpreted what you said as Y, is that right? That wasn't the best forum to share that idea but I do want to hear what suggestions you have, will you tell me? That thought doesn't work for our current timeline, but I'm open to hearing more - maybe there's a different avenue we can apply that to?" I don't want to feel like what I say doesn't have value, it only matters how I say it (omitting inappropriate behavior).
...
- I appreciate consistent updates when things are quickly changing, and written information that allows me time to digest and prepare. 
- If you invite me to a meeting, I need to understand why it’s valuable that I’ll be there. I like meetings that are respectful of everyone’s time and contributions. Sometimes during a meeting-heavy week I prioritize attendance based on my time and mental and watch recordings when it's more efficient. Or if a meeting is socially-focused, I may decline based on bandwidth. 
...
- I can sometimes not give feedback after I’ve noticed something, unless directly asked. Hypocritically, I prefer to get feedback as it happens. If I hear about something for the first time at a review months down the line, I feel like I've really screwed up.
- Rather than sharing popular tools or frameworks that might not have been catered to neurodivergent people, check in and ask "How are you feeling today and what can I support you with today, knowing your needs could change tomorrow?", "What do you need from me to make you feel included and empowered in conversations?", "Is there anything you are struggling with right now? Let's figure out a next step together."
...
- I start with the assumption that we are talking because we all want to solve the same issue, with the best intentions in mind. If there becomes a pattern of mal intent, I will voice my concern with the intention to get back on the same page. 
...
* everything is urgent with no clear priotitization request
...
My love language is not words of appreciation but that doesn't mean I don't want any. I enjoy recognition in a forum where leadership will notice and it will help any future career development. If I look uncomfortable during formal recognition it's because I'm an introvert - I'm fine, don't worry.

**What do you need from your manager?**

* reassurance that my work continues to be good (if applicable)
* direction on how to achieve goals that I've asked about
* continuing conversations on how to demonstrate promotion qualities
* help shifting around workload if it gets overwhelming
* advocacate for me to those who might not have direct access to me or my work

**From your team and peers?**

* feeling comfortable asking questions and being asked questions
* being a sounding board for solving problems
* help for areas outside my expertise
* collaboration so we don't throw things over the fence
* exchanging ideas
* camaraderie
...
Please let me know:
- What would make this document more valuable
